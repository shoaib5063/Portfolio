...
function Experience() {
  return (
    <div id="experience" className="relative z-50 border-t my-12 lg:my-24" style={{borderColor: '#0f2d1e'}}>
      <Image
        src="/section.svg"
        alt="Hero"
        width={1572}
                  ...
                  <GlowCard key={experience.id} identifier={`experience-${experience.id}`}>
                    <div className="p-3 relative">
                      ...
                      <div className="flex items-center gap-x-8 px-3 py-5">
                        <div className="transition-all duration-300 hover:scale-125" style={{color: '#00ff88'}}>
